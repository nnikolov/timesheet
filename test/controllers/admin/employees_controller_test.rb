...
class Admin::EmployeesControllerTest < ActionController::TestCase
  ...
  test "should create admin_employee" do
    assert_difference('Admin::Employee.count') do
      post :create, admin_employee: { active: @admin_employee.active, admin: @admin_employee.admin, first_name: @admin_employee.first_name, last_name: @admin_employee.last_name, password: @admin_employee.password, username: @admin_employee.username }
    end
  ...
  test "should update admin_employee" do
    patch :update, id: @admin_employee, admin_employee: { active: @admin_employee.active, admin: @admin_employee.admin, first_name: @admin_employee.first_name, last_name: @admin_employee.last_name, password: @admin_employee.password, username: @admin_employee.username }
    assert_redirected_to admin_employee_path(assigns(:admin_employee))
  end
